 ...
 * @author matheus
 */
public class UserDao_MD5_SHA256 extends UserDao {

    public UserDao_MD5_SHA256(UserEncryptMode userEncryptMode) throws IOException {
        super("username-md5_password-sha256", userEncryptMode);
    }
